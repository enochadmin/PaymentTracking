<aside class="bg-[rgb(0,204,204)] border-r border-gray-200 dark:border-gray-700 p-4 h-full min-h-screen lg:rounded-md text-white">
    <nav class="space-y-2">
        <div class="text-xs font-semibold text-white/80 uppercase mb-6">Management</div>
        ...
        @if(Auth::user()->hasRole('admin'))
            <div class="pt-4 pb-2 border-t border-white/20 mt-4">
